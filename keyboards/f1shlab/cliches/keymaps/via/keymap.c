...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		KC_TAB,   KC_Q,     KC_W,    KC_E,   KC_R,  KC_T,  KC_Y,  KC_U,  KC_W,    KC_O,   KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,
	...
	[1] = LAYOUT(
		...
		RGB_HUI,  KC_TRNS,  RGB_SAI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_VAI, RGB_MOD,
		RGB_HUD,  KC_TRNS,  RGB_SAD, KC_TRNS,                   KC_TRNS,                            RGB_SAI, RGB_VAD, RGB_SAD
	),
