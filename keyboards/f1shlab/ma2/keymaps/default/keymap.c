...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_F1,      KC_F2,    KC_F3,    KC_F4,    KC_F5,         KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,      C(KC_PGUP),
        C(KC_F1),   C(KC_F2), C(KC_F3), C(KC_F4), C(KC_F5),      C(KC_F6), C(KC_F7), C(KC_F8), C(KC_F9), C(KC_F10),   C(KC_PGDN)
    ),
    [1] = LAYOUT(
